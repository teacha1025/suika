...
namespace suika {
	...
	CODECVT_CONSTEXPR std::u32string to_u32string(const std::u8string_view& src);
	/// <summary>
	/// UTF16文字列をUTF32文字列に変換する
	/// </summary>
	/// <param name="src">元のUTF16文字列</param>
	/// <returns>変換されたUTF32文字列</returns>
	CODECVT_CONSTEXPR std::u32string to_u32string(const std::u16string_view& src);
	/// <summary>
	/// 文字列をUTF32文字列に変換する
	/// </summary>
	/// <param name="src">元の文字列</param>
	/// <returns>変換されたUTF32文字列</returns>
	CODECVT_CONSTEXPR std::u32string to_u32string(const std::string_view& src);
	/// <summary>
	/// ワイド文字列をUTF32文字列に変換する
	/// </summary>
	/// <param name="src">元のワイド文字列</param>
	/// <returns>変換されたUTF32文字列</returns>
	CODECVT_CONSTEXPR std::u32string to_u32string(const std::wstring_view& src);
